...
export default function Cover(props: CoverProps) {
  ...
  return (
    <div id="cover" className="flex flex-col items-center justify-between bg-[#698fc8] text-white min-h-screen pb-24 px-12">
      ...
      <div className="flex flex-col items-center justify-center flex-grow pt-8 text-center">
        ...
        <p className="text-2xl font-light pt-16">{event.mainDate}</p>
        <p className="text-xl pt-20">Kepada:</p>
